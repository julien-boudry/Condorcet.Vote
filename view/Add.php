<div class="container">
	...
	<?php elseif ($this->_mode === 'Public') : ?>
		<input type="text" name="add_name" pattern="[a-zA-Zàáâãäåçèéêëìíîïðòóôõöùúûüýÿ]+" maxlength="20" class="center-block" spellcheck="false">
	<?php endif; ?>
	</section>
	...
	<section>
		...
		<div class="row">
				<div class="col-lg-6 col-md-6 .col-sm-8 col-xs-6 center-block input-group">
					<input type="text" name="add_vote_content" class="form-control" required placeholder="A>B>C=D=E>Z" autocomplete="off" pattern="[a-zA-Z0-9>=àáâãäåçèéêëìíîïðòóôõöùúûüýÿ ]+" spellcheck="false">
				</div><!-- /input-group -->
		</div><!-- /.row -->
	</section>
