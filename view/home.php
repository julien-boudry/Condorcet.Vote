...
<div class="container">
	...
	<section class="home-section">
		...
		<ul>
			...
			<li> <strong>Ranking Pairs</strong> <em>(exprimental implementation at this date)</em></li>
			<li><strong>Kemeny-Young method</strong> <em>Cause of performance consideration, works only for election with less than 6 candidates</em> </li>
			<li> <strong>Copeland method</strong> </li>
			<li> <strong>MiniMax Family methods</strong> </li>
			<ul>
				<li>MiniMax Winning</li>
				<li>MiniMax Opposition</li>
			</ul>
			<li><em>And of course, naturals winner & loser from original Marquis de Condorcet method if there s not <a href="https://en.wikipedia.org/wiki/Voting_paradox" target="_blank">paradox of Condorcet</a></em></li>
		</ul>
		<br><br>
